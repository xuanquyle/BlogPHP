...
class Users extends CI_Controller{
	...
	function insert(){
	    ...
	    $config['allowed_types'] = 'gif|jpg|png|jpeg|bmp'; //duoi anh
		...
		$this->form_validation->set_rules('password', 'Password', 'required|min_length[6]|max_length[40]|htmlspecialchars');
		if($this->form_validation->run() == FALSE){
			$this->session->set_flashdata('msg','error-pass');
