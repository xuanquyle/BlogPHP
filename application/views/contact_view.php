							...
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="blog-item clearfix">						
									...
									<div class="comments-heading text-center mb-30">
										<hgroup>
											<h2 class="font-face1 section-heading">Liên hệ</h2>
										</hgroup>									
									</div>
									...
									<form method="post" action="<?php echo site_url('contact/send');?>" role="form" class="form">
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" name="subject" class="full_width" placeholder="Chủ đề *" maxlength="100" required="">									
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<textarea name="message" class="full_width" rows="6" placeholder="Nội dung *" maxlength="400" required></textarea>										
												</div>
											</div>
