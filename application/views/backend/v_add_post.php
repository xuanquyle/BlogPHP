            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Bài đăng</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="active"><a href="<?php echo site_url('backend/post/add_new');?>">Thêm mới</a></li>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>Tiêu đề</label>
                                            <input type="text" name="title" class="form-control title" placeholder="Nhập tiêu đề" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="slug" class="form-control slug" placeholder="Tiêu đề cũ" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="btn-group btn-group-justified" role="group">
                                            <button type="submit" class="btn btn-primary btn-lg" style="width:100%"><span class="icon-cursor"></span> ĐĂNG BÀI</button>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <textarea name="description" cols="6" rows="6" class="form-control" placeholder="Nhập mô tả"></textarea>
                                        </div>
