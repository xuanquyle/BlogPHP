                                        ...
                                        <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><span class="label label-info">Mới</span></td>
                                                    <?php else:?>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <?php if($row->subscribe_status == '0'):?>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?php echo $row->subscribe_id;?>" title="Duyệt"><span class="fa fa-check"></span></a>
                                                        <?php else:?>
                                                        <?php endif;?>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?php echo $row->subscribe_id;?>" title="Xóa"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
            ...
            <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Duyệt đăng ký Email</h4>
                    </div>
                        <div class="modal-body">
                            <div class="alert alert-info">
                                Bạn muốn duyệt Email này?
                            </div>
                        </div>
                        <div class="modal-footer">
            ...
            <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Xóa Email</h4>
                    </div>
                        <div class="modal-body">
                            <div class="alert alert-info">
                                Bạn muốn xóa Email này?
                            </div>
                        </div>
                        <div class="modal-footer">
