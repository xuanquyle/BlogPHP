    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="<?php echo site_url('backend/settings');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Cài đặt</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="<?php echo site_url('backend/home_setting');?>">Trang chủ</a></li>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Tiêu đề 1</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Tiêu đề 2</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Ảnh tiêu đề</label>
                                            <div class="col-sm-10">
                                                <input type="file" name="img_heading" class="form-control" id="input1">
                                                <p class="help-block">Ảnh tiêu đề phải có độ phân giải 1800 x 1110 Pixels.</p>
                                                <img src="<?php echo base_url().'theme/images/'.$image_heading;?>" width="560" class="thumbnail">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Ảnh nền</label>
                                            <div class="col-sm-10">
                                                <input type="file" name="img_testimonial" class="form-control" id="input1">
                                                <p class="help-block">Ảnh nền phải có độ phân giải 925 x 617 Pixels.</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-success btn-lg">Cập nhập</button>
                                            </div>
                                        </div>
        ...
        <?php if($this->session->flashdata('msg')=='success'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Thành công',
                        text: "Thông tin trang chủ đã được lưu lại!",
