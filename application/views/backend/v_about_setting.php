    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                ...
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Bài đăng</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/post/add_new');?>">Thêm mới</a></li>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Ảnh</label>
                                            <div class="col-sm-10">
                                                <input type="file" name="img_about" class="form-control" id="input1">
                                                <p class="help-block">Ảnh cần có độ phân giải 456 x 470 Pixels.</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description" class="form-control" id="summernote" placeholder="Mô tả"><?php echo $about_desc;?></textarea>
                                            </div>
                                        </div>
        ...
        <?php if($this->session->flashdata('msg')=='success'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Thành công',
                        text: "Thông tin về About đã được lưu lại",
