                            ...
                            <div class="panel-body">
                                ...
                                <div role="tabpanel">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation"><a href="<?php echo site_url('backend/comment');?>">Tất cả bình luận<span class="badge badge-success pull-right m-l-xs"><?php echo $total_all;?></span></a></li>
                                        <li role="presentation" class="active"><a href="#unpublish" aria-controls="all" role="tab" data-toggle="tab" aria-expanded="false">Chờ duyệt<span class="badge badge-danger pull-right m-l-xs"><?php echo $total_rows;?></span></a></li>
                                    </ul>
            ...
            <div class="modal fade" id="ImageModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Đổi hình ảnh</h4>
                    </div>
                        <div class="modal-body">
                            <div class="form-group">
