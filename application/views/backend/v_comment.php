            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="<?php echo site_url('backend/dashboard');?>">Bảng điều khiển</a></li>
                            ...
                            <div class="panel-body">
                                <div class="search p bg-light m-b-sm">
                                    <form action="<?php echo site_url('backend/comment/results');?>" method="GET" data-default="150">
                                        <div class="input-group">
                                            <input type="text" name="search_query" class="form-control input-search" placeholder="Tìm kiếm...">
                                ...
                                <div role="tabpanel">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#all" aria-controls="all" role="tab" data-toggle="tab" aria-expanded="false">Tất cả<span class="badge badge-success pull-right m-l-xs"><?php echo $total_rows;?></span></a></li>
                                        <li role="presentation"><a href="<?php echo site_url('backend/comment/unpublish');?>">Chờ duyệt<span class="badge badge-danger pull-right m-l-xs"><?php echo $total_unpublish;?></span></a></li>
                                    </ul>
                                    <div class="tab-content">
                                        ...
                                        <?php foreach ($data->result() as $row) :?>
                                            <div class="search-item">
                                                ...
                                                <div class="pull-right m-r-md">
                                                    <div class="btn-group">
                                                      ...
                                                      <ul class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <li><a href="javascript:void(0);" class="btn-publish" data-comment_id="<?php echo $row->comment_id;?>"><span class="fa fa-send"></span> Duyệt</a></li>
                                                        <li><a href="javascript:void(0);" class="btn-edit" data-comment_id="<?php echo $row->comment_id;?>" data-comment_msg="<?php echo $row->comment_message;?>"><span class="fa fa-edit"></span> Sửa</a></li>
                                                        <li><a href="javascript:void(0);" class="btn-delete" data-comment_id="<?php echo $row->comment_id;?>"><span class="fa fa-trash"></span> Xóa</a></li>
                                                        <?php else:?>
                                                        <li><a href="javascript:void(0);" class="btn-reply" data-comment_id="<?php echo $row->comment_id;?>" data-post_id="<?php echo $row->post_id;?>"><span class="fa fa-reply"></span> Phản hồi</a></li>
                                                        <li><a href="javascript:void(0);" class="btn-edit" data-comment_id="<?php echo $row->comment_id;?>" data-comment_msg="<?php echo $row->comment_message;?>"><span class="fa fa-edit"></span> Sửa</a></li>
                                                        <li><a href="javascript:void(0);" class="btn-delete" data-comment_id="<?php echo $row->comment_id;?>"><span class="fa fa-trash"></span> Xóa</a></li>
                                                        <?php endif;?>
                                                      </ul>
                                                ...
                                                <a href="javascript:void(0);" class="search-link"><b><?php echo $row->comment_name?></b>, <?php echo $row->comment_date;?></a> <?php if($row->comment_status=='0'){ echo "<span class='label label-danger'>Chờ duyệt</span>";}else{}?>
            ...
            <div class="modal fade" id="ReplyModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Phản hồi bình luận</h4>
                    </div>
            ...
            <div class="modal fade" id="EditModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Chỉnh sửa bình luận</h4>
                    </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <textarea name="comments2" id="comment" class="form-control comment" rows="6" placeholder="Chỉnh sửa..."></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
            ...
            <div class="modal fade" id="PublishModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Duyệt bình luận</h4>
                    </div>
                        <div class="modal-body">
            ...
            <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Xóa bình luận</h4>
                    </div>
                        <div class="modal-body">
                            <div class="alert alert-info">
            ...
            <div class="modal fade" id="ImageModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Đổi ảnh</h4>
                    </div>
                        <div class="modal-body">
                            <div class="form-group">
