                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->testimonial_id;?>"><span class="icon-pencil"></span> Sửa</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-userid="<?php echo $row->testimonial_id;?>"><span class="icon-trash"></span> Xóa</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <textarea name="content" class="form-control" rows="6" placeholder="Nội dung" required></textarea>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input type="text" name="nama" value="<?php echo $row->testimonial_name;?>" class="form-control" placeholder="Tên" required>
                                        </div>
                                        <div class="form-group">
        ...
        <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            <strong>Bạn có muốn xóa lời chứng thực này?</strong>
                            <div class="form-group">
