            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="<?php echo site_url('backend/settings');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Cài đặt</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8" style="margin-top: 10px;">
                                            ...
                                            <div class="input-group">
                                                <button class="btn btn-secondary btn-block"><?php echo $row->navbar_name;?></button>
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Thao tác <span class="caret"></span></button>
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="#" class="btn-submenu" data-nav_id="<?php echo $row->navbar_id;?>">Thêm menu phụ</a></li>
                                                        <li><a href="#" class="btn-edit-menu" data-nav_id="<?php echo $row->navbar_id;?>" data-nav_name="<?php echo $row->navbar_name;?>" data-nav_slug="<?php echo $row->navbar_slug;?>">Sửa</a></li>
                                                        <li><a href="#" class="btn-delete-menu" data-nav_id="<?php echo $row->navbar_id;?>">Xóa</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Nhãn</label>
                                        <input type="text" name="nama" class="form-control" placeholder="Tên nhãn" required>
                                    </div>
                                    <div class="form-group">
                                        <label>URL</label>
        ...
        <div class="modal fade" id="ModalSubmenu" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Thêm menu phụ</h4>
                    </div>
                    <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Nhãn</label>
                                        <input type="text" name="name_submenu" class="form-control" placeholder="Tên nhãn" required>
                                    </div>
                                    <div class="form-group">
                                        <label>URL</label>
                                        <div class="input-group m-b-sm">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Nhãn</label>
                                        <input type="text" name="name_edit" class="form-control name_edit" placeholder="Tên nhãn" required>
                                    </div>
                                    <div class="form-group">
                                        <label>URL</label>
                                        <div class="input-group m-b-sm">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <strong>Bạn có muốn xóa menu này?</strong>
