                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" action="<?php echo site_url('backend/change_pass/change');?>" method="post">
                                      ...
                                      <div class="form-group">
                                        <label for="inputPassword1" class="col-sm-2 control-label">Mật khẩu cũ</label>
                                        <div class="col-sm-10">
                                          <input type="password" name="old_password" class="form-control" id="inputPassword1" placeholder="Mật khẩu cũ" required>
                                        </div>
                                      </div>

                                      <div class="form-group">
                                        <label for="inputPassword2" class="col-sm-2 control-label">Mật khẩu mới</label>
                                        <div class="col-sm-10">
                                          <input type="password" name="new_password" class="form-control" id="inputPassword2" placeholder="Mật khẩu mới" required>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                          <input type="password" name="conf_password" class="form-control" id="inputPassword3" placeholder="Xác nhận mật khẩu" required>
                                        </div>
                                      </div>
