                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Bài đăng</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="<?php echo site_url('backend/post');?>">Danh sách bài</a></li>
                        ...
                        <li class="droplink active open"><a href="<?php echo site_url('backend/settings');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Cài đặt</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="active"><a href="<?php echo site_url('backend/settings');?>">Website</a></li>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Tên</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Mô tả</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <p class="help-block">Favicon phải có độ phân giải 32 x 32 Pixels.</p>
                                                <img src="<?php echo base_url().'theme/images/'.$site_favicon;?>" class="thumbnail">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Logo tiêu đề</label>
                                            <div class="col-sm-10">
                                                <input type="file" name="logo_header" class="form-control" id="input1">
                                                <p class="help-block">Logo phải có độ phân giải 248 x 54 Pixels.</p>
                                                <img src="<?php echo base_url().'theme/images/'.$site_logo_header;?>" class="thumbnail">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2 control-label">Logo lớn</label>
                                            <div class="col-sm-10">
                                                <input type="file" name="logo_big" class="form-control" id="input1">
                                                <p class="help-block">Logo lớn phải có độ phân giải 560 x 315 Pixels.</p>
