                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="#" class="logo-name text-lg text-center">LIFE BLOG</a>
                                <p class="text-center m-t-md">Đăng nhập.</p>
                                ...
                                <p class="text-center m-t-xs text-sm"><?php echo date('Y');?> &copy; Nhóm 4.</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
