            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        <li class="active"><a href="<?php echo site_url('backend/dashboard');?>" class="waves-effect waves-button"><span class="menu-icon icon-home"></span><p>Bảng điều khiển</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="<?php echo site_url('backend/dashboard');?>">Trang chủ</a></li>
                ...
                <div id="main-wrapper">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Lượt xem bài viết</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-eye"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Bài viết</span>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Bình luận</span>
                                    </div>
                                    <div class="info-box-icon">
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="visitors-chart">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">Truy cập trong tháng</h4>
                                            </div>
                                            <div class="panel-body">
                                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="stats-info">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">Thống kê trình duyệt</h4>
                                            </div>
                                            <div class="panel-body">
                                                <ul class="list-unstyled">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Top 5 bài viết</h4>
                                </div>
                                <div class="panel-body">
