...
<html lang="en">
	...
	<body class="content-animate">
		...
		<div class="page-loader">
			...
			<div class="loader font-face1">Đang tải...	
			</div>
		</div>   
							...
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="blog-item clearfix">						
									...
									<div class="blog-item-meta font-face1">
										...
										<span class="separator">&vert;</span>
										<span><a href="javascript:void(0)"><i class="fa fa-eye"></i> <?php echo number_format($views).' Lượt xem';?></a></span>
										<span class="separator">&vert;</span>
										<span><a href="javascript:void(0)"><i class="fa fa-comments"></i> <?php echo number_format($comment);?> Bình luận</a></span>
									</div>
									...
									<div class="comments-heading text-center mb-30 mt-60">
										<hgroup>
											<h2 class="font-face1 section-heading"><?php echo $comment;?> Bình luận</h2>
									...
									<div class="comments-heading text-center mb-30">
										<hgroup>
											<h2 class="font-face1 section-heading">Để lại bình luậnt</h2>
										</hgroup>									
									</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													 <input type="text" name="name" class="full_width" placeholder="Tên *" maxlength="100" required="">										
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
											...
											<div class="col-md-12">
												<div class="form-group">
													<textarea name="comment" class="full_width" rows="6" placeholder="Bình luận *" maxlength="400" required></textarea>										
												</div>
											</div>
							...
							<div class="col-md-10 col-md-offset-1">	
								<div class="form-subscribe mb-50 mb-sm-0">
									<div class="col-sm-6 mb-sm-40">
										<h2 class="heading5 mt-0 font-face1 white-color fw700 mb-0" >Bài đăng mới.</h2>
									</div>
									<div class="col-sm-6">										
		      ...
		      <div class="modal-body">	
		      	<form action="<?php echo site_url('search');?>" method="GET">
		        	<div class="input-group">
		              <input type="text" name="search_query" class="form-control input-search" style="height: 40px;" placeholder="Tìm kiếm..." required>
